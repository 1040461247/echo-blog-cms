...
export const ARTICLE_LIST_PATH = `${ARTICLE_PATH}/article-list`
export const ARTICLE_EDITOR_PATH = `${ARTICLE_PATH}/article-editor`
export const ARTICLE_ATTACHMENT_PATH = `${ARTICLE_PATH}/article-attachment`
...
export const FRIEND_LIST_PATH = `${FRIEND_PATH}/friend-list`
export const FRIEND_APPLY_PATH = `${FRIEND_PATH}/friend-apply`
